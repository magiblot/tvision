...
* [TV-Transmission](https://github.com/zanac/tv-transmission) by [Vanni Brutto](https://github.com/zanac), a Transmission Torrent Client multi language that implement all Transmission RPC API
