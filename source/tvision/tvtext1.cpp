...
const char * _NEAR TFrame::dragIcon = "~��~";
...
const char * _NEAR TDirListBox::pathDir   = "���";
const char * _NEAR TDirListBox::firstDir  =   "���";
const char * _NEAR TDirListBox::middleDir =   " ��";
const char * _NEAR TDirListBox::lastDir   =   " ��";
const char * _NEAR TDirListBox::drives = "Drives";
const char * _NEAR TDirListBox::graphics = "���";
